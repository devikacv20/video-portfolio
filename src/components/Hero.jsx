...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 md:px-8 lg:px-10 max-w-[1600px] mx-auto flex flex-col md:flex-row justify-center md:justify-between items-start text-left w-full h-full pt-36 md:pt-[18%]"> 
        
        {/* Left Side: Text and Buttons - Shifted higher up */}
        <div className="flex flex-col items-start text-left w-[38%] max-w-[520px]">
          ...
          >
          I build scalable applications and explore machine learning — from Earth observation to real-time systems.
          </p>

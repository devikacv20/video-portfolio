    ...
    >
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          Combining machine learning, data science, and full-stack development to build scalable, real-world AI solutions.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            ...
            text="Building and evaluating classification, regression, and recommendation models using Scikit-learn, XGBoost, and feature engineering."
          ...
          <TagCard
            ...
            text="Building secure REST APIs and web applications using Django, Django REST Framework, and JWT authentication."
          ...
          <TagCard
            ...
            text="Data analysis with NumPy, Pandas, and Matplotlib, plus deep learning using CNNs and TensorFlow."
          ...
          <TagCard
            ...
            text="Version control with Git and GitHub, containerization with Docker, and deployment on AWS."

...
const Skills = () => {
  const skillsData = [
    ...
    },
    {
      ...
      skills: ['Python', 'Java', 'C', 'Django', 'Django REST Framework', 'JWT Auth'],
    },
    {
      category: 'AI & Machine Learning',
      skills: ['Scikit-learn', 'XGBoost', 'NumPy', 'Pandas', 'Matplotlib', 'CNN', 'TensorFlow', 'GANs'],
    },
    {
      category: 'Tools & Cloud',
      skills: ['PostgreSQL', 'MongoDB', 'MySQL', 'Docker', 'Git', 'GitHub', 'AWS', 'Postman'],
    },
  ];
